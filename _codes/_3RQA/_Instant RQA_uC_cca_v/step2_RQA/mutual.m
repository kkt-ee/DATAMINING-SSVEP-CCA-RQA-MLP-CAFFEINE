...
if nargout == 0
    ...
    title('Mutual Information Test (first local minimum)','FontSize',20,'FontWeight','bold');
    xlabel('Delay (sampling time)','FontSize',30,'FontWeight','bold');
    ylabel('Mutual Information','FontSize',30,'FontWeight','bold');
    get(gcf,'CurrentAxes');
