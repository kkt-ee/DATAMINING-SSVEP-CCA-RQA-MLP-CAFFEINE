...
%{
load /mnt/pd/0vars/sigVecVectorA1-6forRQA.mat
savefilename='deldel'
rrv=sigVecVector{1};
sig=rrv{1,2}{1};
%}
...
title('False nearest neighbor test','FontSize',20,'FontWeight','bold');
xlabel('Dimension','FontSize',30,'FontWeight','bold');
ylabel('FNN','FontSize',30,'FontWeight','bold');
get(gcf,'CurrentAxes');
...
title('EKG time-delay embedding - state space plot','FontSize',20,'FontWeight','bold');
grid on;
set(gca,'CameraPosition',[25.919 27.36 13.854]);
xlabel('x(t)','FontSize',30,'FontWeight','bold');
ylabel('x(t+\tau)','FontSize',30,'FontWeight','bold');
zlabel('x(t+2\tau)','FontSize',30,'FontWeight','bold');
set(gca,'LineWidth',2,'FontSize',20,'FontWeight','bold');
